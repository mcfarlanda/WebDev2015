<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CheckoutForm.aspx.cs" Inherits="Pages_CheckoutForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DropDownList ID="ddlState" runat="server" CssClass="entry"
        AppendDataBoundItems="True" DataTextField="StateName" DataValueField="StateCode" DataSourceID="SqlDataSource1">
        <asp:ListItem Text="" Value="" Selected="True"></asp:ListItem>
    </asp:DropDownList>
    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:HalloweenConnectionString %>' SelectCommand="SELECT [StateCode], [StateName] FROM [States] ORDER BY [StateCode]"></asp:SqlDataSource>
    <asp:RequiredFieldValidator ID="rfvState" runat="server" 
        ...
        <asp:Button ID="btnCheckOut" runat="server" Text="SUBMIT ORDER" CssClass="button" 
