...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table>
        ...
        <tr>
            <td>
                <asp:LinkButton ID="lnkContinue" runat="server" PostBackUrl="~/Pages/Home.aspx">Continue Shopping</asp:LinkButton> OR
                <asp:Button ID="checkoutBtn" runat="server" PostBackUrl="~/Pages/CheckoutForm.aspx" CssClass="button" Width="100px" Text="Check Out" />
            </td>
        </tr>
    </table>
</asp:Content>
